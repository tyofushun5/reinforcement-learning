...
from RCJ_Reinforcement_learning.tools.rcjs_reward_calculation import SecondRewardCalculation


class SecondEnvironment(gym.Env):
    def __init__(self, create_position, max_steps, magnitude, gui=False):
        ...
        self.reward_cal = SecondRewardCalculation()
